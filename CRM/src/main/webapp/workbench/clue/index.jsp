...
/*---页面加载之后执行---*/
		$(function(){
			...
			$("#selectBtn").click(function(){
				$("#hidden-fullname").val($.trim($("#select-fullname").val()));
				$("#hidden-company").val($.trim($("#select-company").val()));
				$("#hidden-mphone").val($.trim($("#select-mphone").val()));
				$("#hidden-owner").val($.trim($("#select-owner").val()));
				$("#hidden-phone").val($.trim($("#select-phone").val()));
				$("#hidden-source").val($.trim($("#select-source").val()));
				$("#hidden-state").val($.trim($("#select-state").val()));
				pageList(1, 3);
			})
			...
			$.ajax({
				...
				success:function(data){
					...
					$.each(data.dataList, function(i, e){
						...
						html += '<tr>';
						html += '	<td><input type="checkbox" class="xz"  id="' + e.id + '" /></td>';
						html += '	<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/clue/detail.do?id='+ e.id +'\';">'+ e.fullname +'</a></td>';
...
/*---自定义全选/全不选方法---*/
		function AllOrNone(){
			...
			$("#clueListShow").on("click", $(".xz"), function(){
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form" id="createClue">
